...
Please [open an issue](https://github.com/serokell/haskell-algorand-sdk/issues/new/choose) if you find a bug or have a feature request.
...
but, basically, it all boils down to the following:
  ...
  * Add the following header at the very top (but below the shebang, if there
    ...
    Note: you can use `reuse addheader` which automates the process.
